...
{
    /// <summary>
    /// Note that it is also critical to override ToString and concatenate all fields in your class! This is used when searching across each supported file type.
    /// <remarks>
    ...
    public interface IFileSpec
    {
        ...
        /// <summary>
        /// This should be the exact headers this type expects to process. These values are compared to what is in a file being loaded.
        /// <remarks>
        /// Case insensitive
        /// </remarks>
        /// </summary>
        ...
        /// <summary>
        /// This will be populated with previously tagged lines (when session files are used). This allows for 're-tagging' previously tagged rows.
        /// </summary>
