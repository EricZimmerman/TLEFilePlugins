...
namespace TLEFileTzWorks
{
          ...
          public class PeScanOutData : IFileSpecData
    {
        ...
        {
            return $"{CompiledTime} {CreatedTime} {AccessedTime} {ModifiedTime} {Size} {FileType} {CPU} {Linker} {CodeSize} {InitData} {UInitData} {ImageVer} {SubsysVer} {MinimumOS} {EntryOva} {EntryFAddress} {ImageBase} {Signed} {CheckSum} {MD5} {Company} {FilePath} {Rating} {Notes} {PeId} {SymbolFile}";
        }
    }

  
    public class PeScanOut : IFileSpec
    {
        public PeScanOut()
        {
      ...
      public class WispOutData : IFileSpecData
    {
        ...
        public override string ToString()
        {
            return $"{MftEntry} {MftSequence} {ParentEntry} {ParentSequence} {EntryType} {AccessedTime} {ModifiedTime} {CreatedTime} {RecordChangedTime} {FileType} {SizeReserved} {SizeUsed} {Flags} {Name} {Comment}";
        }
    }

    public class WispOut : IFileSpec
    {
        public WispOut()
        {
            //Initialize collections here, one for TaggedLines TLE can add values to, and the collection that TLE will display
            ...
            DataList.Clear();
                    ...
                    using (var fileReader = File.OpenText(filename))
                    {
                        ...
                        while (csv.Read())
                        {
                            ...
                            {
                                wi.RecordChangedTime = DateTime.Parse($"{recordChanged} {recordChangedTime}", CultureInfo.InvariantCulture,
                                        DateTimeStyles.AssumeUniversal)
                                    .ToUniversalTime();
                            }
                            ...
                            if (flags.Length > 0)
                            {
                                ...
                                var valOk = int.TryParse(rawNum, NumberStyles.HexNumber, CultureInfo.InvariantCulture, out rawFlag);
